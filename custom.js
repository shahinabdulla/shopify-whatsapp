document.addEventListener("DOMContentLoaded", function () {
    const paymentContainer = document.querySelector(".product-form__payment-container"), productTitle = document.querySelector("h1.product-meta__title"); if (paymentContainer) {
        const whatsappButton = document.createElement("a"), whatsappButtonHTML = `<a style="margin-top:10px;" href="https://api.whatsapp.com/send?phone=+97470574780&amp;text=${`I'm interested in the product: ${encodeURIComponent(productTitle.textContent.trim())}`}" target="_blank" rel="noopener" aria-describedby="a11y-new-window-message" aco-visited="true"><div class="order_whatsapp" style="padding: 9px;text-align: center; background-color: #1EA651;height:47px;color:white;"><img src="https://cdn.shopify.com/s/files/1/0073/2522/0979/files/
